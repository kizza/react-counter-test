...
describe('App', function() {
	...
	it('should increment total of a single child counter', function() {
		component.createNewCounter('Test counter');
	...
	it('should increment total of multiple child counters', function() {
	...
	it('should decrement total of a single child counter', function() {
		component.createNewCounter('Test counter');
		var counter = findByType(component, Counter);
	...
	it('should decrement total of multiple child counters', function() {
